...
const TeamDetailScreen = () => {
  ...
  const mockTeam = {
    ...
    fullDescription: "Команда RemontBistro, мастера своего дела в сфере ремонта, отделки и малоэтажного строительства. Более 8 лет опыта, десятки реализованных проектов, довольные клиенты и репутация, на которую мы по-настоящему опираемся. Мы выполняем как комплексные ремонты под ключ, так и отдельные виды работ с неизменно высоким качеством и в срок.",
    email: "remontbistro@gmail.com",
    phone: "+7 (777) 123-45-67",
    categories: ["Демонтаж", "Отделка", "Дизайн интерьеров", "Сантехника", "Электрика"],
    gallery: [
    ...
    reviews: [
      {
        ...
        rating: 5.0,
        role: "Клиент",
        text: "Хочу выразить огромную благодарность команде RemontBistro за отличную работу! Быстро, качественный ремонт квартиры — от демонтажа до чистовой отделки. Всё выполнено аккуратно, профессионально и в срок.",
      ...
      <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
        <div className="relative">
          {team.gallery && team.gallery.length > 0 ? (
            <>
              <img
                src={team.gallery[activeImageIndex]?.img}
                alt="Работы исполнителя"
                className="w-full h-64 object-cover"
              />
              {team.gallery.length > 1 && (
