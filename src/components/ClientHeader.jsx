...
import { Bell, User, Home, Briefcase, Users, MessageSquare, Search } from 'lucide-react';
...
const ClientHeader = () => {
  ...
  const navItems = [
    ...
    { path: '/projects', label: 'Проекты / Заявки', icon: Briefcase },
    { path: '/teams', label: 'Исполнители', icon: Users },
